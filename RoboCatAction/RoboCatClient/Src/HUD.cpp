...
void HUD::RenderShield()
{
	if (mShield >= 0)
	{
		string sheildString = StringUtils::Sprintf("Shield %d", mShield);
		RenderText(sheildString, mShieldOffset, Colors::Blue);
	}
}
